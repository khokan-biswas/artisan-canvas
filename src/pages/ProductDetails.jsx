...
// Adjust the path '../assets/...' based on where this file is located relative to the assets folder
          ...
          <div className="relative bg-white w-full max-w-6xl h-[90vh] rounded-none overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="relative w-full h-full bg-gray-900 flex items-center justify-center overflow-hidden">
              ...
              <div
                ...
                style={{
                  // 1. STRICT LIMITS (Modify these pixels to control max size)
                  maxWidth: '350px',
                  maxHeight: '280px',

                  // 2. Auto sizing to fit content up to the max limits
                  width: 'auto',
                  height: 'auto',

                  // 3. Realistic Frame Styles
                  border: '12px solid #111', // Black Frame thickness
                  backgroundColor: '#fff',
                  padding: '10px', // White mount (passe-partout)
                  outline: '1px solid #444', // Subtle outer edge
                  boxSizing: 'border-box'
                }}
              >
                {/* Image is forced to fit within the container's max-width/height */}
                <img
                  src={selectedImage}
                  alt="Framed Painting"
                  className="block w-full h-full object-contain"
                  style={{
                    maxHeight: '240px' // Ensures image doesn't overflow frame vertically
                  }}
                />
