...
const CATEGORIES = [
  ...
  'Cloudscape', 'Flora', 'Expressionism', 'Folk Art',
  'Tribal Art', 'Digital Art', 'Woman', 'Pop Art',
  'Miniature', 'Spiritual', 'Contemporary', 'Wildlife',
  'Seascape', 'Urban', 'Figurative', 'Minimalist',
  'Surrealism', 'Mythological', 'Calligraphy', 'Botanical', 'Misc'
];
